...
$params["nick"] =$_SESSION['username'];  // setup the intitial nickname$params["nick"] = "guest".rand(1,1000); 
...
<?php
  ...
  $params["nick"]     = "chutiya"; // it can be useful to take nicks from a database
  $chat = new phpFreeChat($params);
